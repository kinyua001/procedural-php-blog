...
<head>
    ...
    <!-- Custom CSS -->
    <link href="<?php echo APP_URL; ?>public/dashboard/assets/libs/fullcalendar/dist/fullcalendar.min.css"
        rel="stylesheet" />
    <link href="<?php echo APP_URL; ?>public/dashboard/assets/extra-libs/calendar/calendar.css" rel="stylesheet" />
    <link href="<?php echo APP_URL; ?>public/dashboard/dist/css/style.min.css" rel="stylesheet">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href=""
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                                    src="<?php echo APP_URL; ?>public/dashboard/assets/images/users/1.jpg" alt="user"
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                ...
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="<?php echo APP_URL; ?>auth/logout.php"><i
